...
\begin{quote}
    ...
    \begin{quote}
		...
		\begin{quote}
            ...
            dieser zweiten Methode ist, dass sie sehr viel einfacher auf der Empfängerseite zu realisieren ist als die erst Art der Demodulation.
...
\begin{quote}
    ...
    \begin{quote}
     ...
     \end{equation*}
        ...
        (müssen wir auf jeden Fall noch ergänzen, und auch noch die Messreihe
        mit dem $1 kHz$ Sinusnutzsignal, damit wir einen Vergleich anstellen
        können, so wie in der Aufgabe erwartet\ldots)
        
        Hier sollten dann die Spektren beider FM Modulationen verglichen werden,
        mit sinus $1 kHz$ und sinus $3 kHz$\ldots
