...
%                 \begin{figure}[H]
%                 \centering
%                     \includegraphics[scale=0.5, trim = trim = 4cm 9.5cm 3.5cm
%                     9.5cm,clip]{./Bilder/synchDemodFilter_rechteck}
%                         \caption{AM-demoduliertes und TP-gefiltertes Rechtecksignal}
%                 \end{figure}
